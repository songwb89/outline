...
const MockData = {
  ...
  teachingStructure: {
    ...
    phases: {
      ...
      subPhases: {
        '课程开场与旧知回顾': [
          { name: '课堂问候', timeRange: "0'00\"-0'30\"", content: '教师与学生互相问候，师生以饱满的精神状态开启本节课的学习。教师通过轻松自然的开场白，拉近与学生的距离，营造和谐有序的课堂氛围，为后续教学活动的顺利开展做好铺垫。' },
          { name: '背诵检查', timeRange: "0'30\"-2'15\"", content: '教师检查学生对上节课所学内容的掌握情况，随机点名请学生背诵《春江花月夜》的相关段落。通过这一环节，帮助学生回忆已学知识，同时了解学生的预习效果，为新课讲授奠定基础。' },
          { name: '旧知提问', timeRange: "2'15\"-4'45\"", content: '教师针对上节课所学的诗歌意象、修辞手法等内容进行提问，引导学生回顾张若虚《春江花月夜》的创作背景及诗歌基本结构。通过互动问答的方式，激活学生的知识储备，建立新旧知识之间的联系。' }
        ],
        '新课导入': [
          { name: '创设情境', timeRange: "4'45\"-6'00\"", content: '教师播放轻柔典雅的古筝背景音乐，配合多媒体展示春江月夜的诗意画面。通过视听结合的方式，将学生带入诗歌所描绘的优美意境之中，激发学生的学习兴趣和审美情感，为品读诗句做好情感准备。' },
          { name: '引入课题', timeRange: "6'00\"-8'30\"", content: '教师结合刚才的意境营造，自然引出本节课的主题——继续深入学习《春江花月夜》。引导学生关注诗歌下半阕的独特视角和情感内涵，明确本节课的学习目标，带着问题有针对性地进入文本探究环节。' },
          { name: '预习检查', timeRange: "8'30\"-11'04\"", content: '教师通过课堂提问的方式，检查学生预习作业的完成情况，了解学生对诗歌下半阕内容的自主学习程度。针对学生在预习中遇到的难点问题进行汇总，为后续的课堂教学提供依据，实现以学定教的教学策略。' }
        ],
        '文本深入分析': [
          { name: '过渡句分析', timeRange: "11'24\"-13'35\"", content: '教师引导学生关注诗歌中承上启下的过渡语句，分析诗人如何自然地从思妇视角转向游子视角。通过品味"白云一片去悠悠"等过渡性意象，帮助学生理解诗歌结构的精妙之处，感受古诗起承转合的写作智慧。' },
          { name: '意象解读', timeRange: "13'35\"-16'39\"", content: '教师带领学生深入分析"玉户帘中卷不去，捣衣砧上拂还来"等关键意象的独特内涵。引导学生体会思妇触景生情、难以排解的相思之苦，品味诗歌以景写情、情景交融的艺术手法，感受古典诗歌意象营构的精妙之美。' },
          { name: '诗句理解与感受分享', timeRange: "16'39\"-18'12\"", content: '教师请学生自由分享对诗句的理解和情感体验，鼓励学生用自己的语言阐述诗歌意境。通过师生对话和生生互动，帮助学生深化对诗歌内涵的理解，同时训练学生的语言表达能力，培养主动思考和表达的学习习惯。' },
          { name: '大胆想法与意象分析', timeRange: "18'12\"-21'37\"", content: '教师引导学生关注诗歌中"鸿雁""鱼龙"等特殊意象，分析其在诗歌中承载的情感功能。深入探讨游子思妇两端呼应的艺术构思，体会诗人如何通过丰富奇特的想象，将天上人间的思念之情融为一体。' },
          { name: '后世诗歌对比', timeRange: "21'37\"-24'01\"", content: '教师将《春江花月夜》与后世相关题材的诗歌进行对比赏析，引导学生认识张若虚这首诗在诗歌史上的独特地位和深远影响。通过跨时代的诗歌比较，拓宽学生的文学视野，加深对经典作品艺术价值的理解和认同。' },
          { name: '画面与视角转换', timeRange: "24'01\"-24'40\"", content: '教师引导学生梳理诗歌中画面切换和视角转换的脉络，分析诗人如何巧妙运用时空转换手法。通过图示法或板书的形式，帮助学生建立对全诗结构布局的整体认知，把握诗歌情感流动的内在逻辑。' },
          { name: '游子部分分析', timeRange: "24'40\"-27'53\"", content: '教师聚焦诗歌后半部分的游子形象，引导学生分析游子面对春江明月时的内心世界。品味"不知乘月几人归"等诗句蕴含的复杂情感，体会诗人对人生际遇的深刻思考，感受诗歌意境的开阔与深远。' },
          { name: '学生感受分享', timeRange: "27'53\"-30'05\"", content: '教师为学生提供充分表达个人阅读体验的机会，鼓励学生分享对游子形象或相关诗句的独到见解。通过开放性的讨论交流，激发学生的审美想象力和文学感悟力，同时教师给予适当的点拨和提升。' },
          { name: '结尾诗句分析', timeRange: "30'05\"-37'54\"", content: '教师引导学生重点品析诗歌结尾的意境营造，分析"落月摇情满江树"这一千古名句的艺术魅力。深入探讨诗人如何以景结情、意犹未尽，体会古典诗歌含蓄蕴藉的审美特质，感受诗歌余韵悠长的艺术效果。' },
          { name: '手法讨论', timeRange: "37'54\"-42'21\"", content: '教师组织学生对全诗所运用的主要艺术手法进行归纳总结，包括比兴、夸张、虚实结合等表现技巧。通过小组合作探究的方式，引导学生深入理解诗歌艺术手法与情感表达之间的关系，提升学生的诗歌鉴赏能力。' }
        ],
        '课程总结与巩固提升': [
          { name: '梳理脉络', timeRange: "42'01\"-42'45\"", content: '教师带领学生回顾本节课的学习内容，系统梳理《春江花月夜》下半阕的脉络结构。帮助学生建立完整的知识框架，强化对诗歌意象、情感、手法的整体认知，实现知识的内化与巩固。' },
          { name: '布置作业', timeRange: "42'45\"-43'37\"", content: '教师根据本课教学目标和学生实际水平，布置分层作业。作业内容包括背诵指定段落、撰写赏析短文、预习下节课内容等，引导学生进行拓展学习，实现课堂学习与课外延伸的有机结合。' }
        ]
      }
    },
          ...
          nodes: [
            {
              ...
              thinking: '形象思维',
              thinkingDesc: '通过分析诗歌中的意象，如白云、扁舟、明月楼等，引导学生进行联想和想象。',
              situation: '复杂情境',
              situationDesc: '问题涉及多个意象的复杂关系，需要学生综合理解。',
              chainType: '收敛型',
              chainTypeDesc: '从开放的意象分析逐步聚焦到具体的意象作用。',
              relatedQuestions: [
                '白云一片去悠悠，青枫浦上不胜愁是怎样的意象',
                '白云飘到了哪里',
                '扁舟子是什么',
                '扁舟是在什么上面',
                '江上除了送流水还有什么',
                '明月楼畔的楼上有谁',
                '玉户帘和捣衣砧这两个意象有什么特别的地方',
                '不写窗帘写门帘，门帘有什么作用',
                '玉户帘是什么',
                '他写门帘有什么作用'
              ]
            ...
            {
              label: '情感体验',
              coreQuestion: '游子和思妇为什么愁',
              thinking: '形象思维',
              thinkingDesc: '通过分析游子和思妇的情感，引导学生体验诗歌中的情感世界。',
              situation: '复杂情境',
              situationDesc: '问题涉及情感的复杂表达和变化。',
              chainType: '提高型',
              chainTypeDesc: '从简单的情感描述逐步深入到情感的复杂表达。',
              relatedQuestions: [
                '游子和思妇为什么愁',
                '游子和思妇的相思离别之情是他们独有的吗',
                '这种感情是什么样的',
            ...
            {
              label: '哲理探讨',
              coreQuestion: '前面张若虚讲的人和自然关系是怎样的',
              thinking: '辩证思维',
              thinkingDesc: '通过分析诗歌中的哲理，引导学生从联系和发展的角度理解诗歌。',
              situation: '复杂情境',
              situationDesc: '问题涉及哲理的深层探讨和联系。',
              chainType: '收敛型',
              chainTypeDesc: '从开放的哲理探讨逐步聚焦到具体的哲理表达。',
              relatedQuestions: [
                '前面张若虚讲的人和自然关系是怎样的',
                '第五小节内容起了什么作用',
                '李白的我寄愁心与明月是否有愿逐月华流照君的感受？',
                '这8句构成了怎样的图形图像，主人公是谁？',
                '女孩子在美好愿想里追月光到了谁身边？',
                '游子在干嘛？',
                '今夜是什么？',
            ...
            {
              label: '意象与情感的结合',
              coreQuestion: '这种说法和愿逐月光流照君有无异曲同工之妙',
              thinking: '辩证思维',
              thinkingDesc: '通过分析意象与情感的结合，引导学生理解诗歌中的情感寄托。',
              situation: '复杂情境',
              situationDesc: '问题涉及意象与情感的复杂关系。',
              chainType: '提高型',
              chainTypeDesc: '从简单的意象与情感描述逐步深入到复杂的关系分析。',
              relatedQuestions: [
                '这种说法和愿逐月光流照君有无异曲同工之妙',
                '这个妇人还愿意照镜子吗？',
                '为什么不愿意照镜子了？',
                '这种说法和愿随愿逐月光流照君是否异曲同工？',
                '诗歌后半部分花怎么样了？',
                '捣衣针指的是什么，何时用？',
                '现在已经什么时候了？',
                '春天流去了，人的生命怎么样了？',
            ...
            {
              label: '诗歌结构与手法',
              coreQuestion: '这8句用了哪些手法来表现游子对思妇的相思？',
              thinking: '逻辑思维',
              thinkingDesc: '通过分析诗歌的结构和表现手法，引导学生理解诗歌的艺术形式。',
              situation: '复杂情境',
              situationDesc: '问题涉及诗歌结构和手法的复杂分析。',
              chainType: '收敛型',
              chainTypeDesc: '从开放的结构和手法分析逐步聚焦到具体的艺术表现。',
              relatedQuestions: [
                '这8句用了哪些手法来表现游子对思妇的相思？',
                '你觉得这些哪一句用了手法，用了什么手法？',
                '梦是怎么样呢？',
                '那你还能再看到别的吗？',
                '以景结情很好，那摇情满江树情是可以摸到看到的东西吗？',
                '想一下你在学这首诗的时候都是哪些场景，哪些意象勾勒出江潮连海月共潮生的图像？',
                '闲谈落花等一系列的都是什么？',
                '用一系列意象把情寄托在了什么上面？',
                '从歌声中能感受到什么？'
              ]
    ...
    contentOrganization: {
      ...
      knowledgeDetail: {
        '咏物抒怀诗': {
          ...
          audioTime: { current: '0:00', total: '5:12' }
        },
        '意象': {
          definition: '意象是诗歌中通过具体形象表达抽象情感的艺术手法，是诗歌情感和意境的重要载体。',
          activity: '教师引导学生分析诗中出现的意象',
          content: ['意象的定义', '意象与情感的关系', '《春江花月夜》中的核心意象'],
          methods: ['提问引导', '小组讨论'],
          errorPoint: '学生可能混淆意象与普通景物描写',
          audioTime: { current: '0:00', total: '4:30' }
        },
        '思乡怀人': {
          definition: '思乡怀人是诗歌中常见的主题，表达对故乡或亲人的思念之情。',
          activity: '教师引导学生分析游子思妇的思乡怀人之情',
          content: ['思乡怀人的情感内涵', '诗歌中的情感表达'],
          methods: ['提问引导', '朗读体会'],
          errorPoint: '学生可能无法深入体会诗歌中的情感内涵',
          audioTime: { current: '0:00', total: '4:10' }
        },
        '情景交融': {
          definition: '情景交融是指诗歌中景物描写与情感表达相互渗透、浑然一体的艺术手法。',
          activity: '教师引导学生体会景物描写与情感表达的结合',
          content: ['情景交融的定义', '诗歌中的典型案例'],
          methods: ['讲解', '朗读体会'],
          errorPoint: '学生可能难以区分单纯景物描写与情景交融的区别',
          audioTime: { current: '0:00', total: '3:45' }
        },
        '象征': {
          definition: '象征是通过具体形象暗示抽象概念或情感的艺术手法。',
          activity: '教师引导学生理解诗中月光的象征意义',
          content: ['象征的定义', '月光在诗歌中的象征意义'],
          methods: ['讲解', '提问引导'],
          errorPoint: '学生可能难以准确把握象征物与被象征物之间的关系',
          audioTime: { current: '0:00', total: '3:20' }
        },
        '虚实结合': {
          definition: '虚实结合是通过现实与想象的交织来拓展诗歌意境的手法。',
          activity: '教师引导学生分析虚实相生的表现手法',
          content: ['虚实结合的定义', '诗歌中的虚实描写'],
          methods: ['讲解', '小组讨论'],
          errorPoint: '学生可能混淆虚实描写的界限',
          audioTime: { current: '0:00', total: '2:55' }
        },
        '动静结合': {
          definition: '动静结合是通过静态与动态描写的对比来增强艺术表现力的手法。',
          activity: '教师引导学生分析动静结合的描写手法',
          content: ['动静结合的定义', '诗歌中的动静描写'],
          methods: ['举例分析', '提问引导'],
          errorPoint: '学生可能无法准确识别诗中的动静态描写及其作用',
          audioTime: { current: '0:00', total: '3:10' }
        },
        '借景抒情': {
          definition: '借景抒情是通过描写景物来间接表达情感的艺术手法。',
          activity: '教师引导学生理解诗人如何通过景物描写抒发情感',
          content: ['借景抒情的定义', '诗歌中的借景抒情案例'],
          methods: ['讲解', '朗读体会'],
          errorPoint: '学生可能无法准确理解景物与情感的内在联系',
          audioTime: { current: '0:00', total: '3:30' }
        },
        '以景结情': {
          definition: '以景结情是通过景物描写来收束全诗、含蓄表达情感的手法。',
          activity: '教师引导学生分析结尾手法的艺术表现',
          content: ['以景结情的定义', '诗歌结尾的艺术效果'],
          methods: ['讲解', '朗读体会'],
          errorPoint: '学生可能无法理解结尾景物描写的深意',
          audioTime: { current: '0:00', total: '3:05' }
        }
      },
